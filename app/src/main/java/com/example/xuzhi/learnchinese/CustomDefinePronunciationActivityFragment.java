 ...
 */
public class CustomDefinePronunciationActivityFragment extends Fragment {
    View rootView;
    final static String TEMP_CUSTOM_PRONUNCIATION_SUFFIX = "_c.3gp";
    final static String CUSTOM_PRONUNCIATION_SUFFIX = ".3gp";
    //final static String CUSTOM_PRONUNCIATION_FOLDER = "/LearnChineseCP/";
    //static Spinner mToneTypeSpinner;
    ...
    public CustomDefinePronunciationActivityFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*tone type spinner
        mToneTypeSpinner  = (Spinner)rootView.findViewById(R.id.tone_type);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getActivity(),
                R.array.tone_type, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mToneTypeSpinner.setAdapter(adapter);
        mToneTypeSpinner.setSelection(1);*/
        ...
        mRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*File privateDir = new File(mDirName);
                if (!privateDir.exists()) {
                    privateDir.mkdir();
                }*/
                //mDirName = Environment.getExternalStorageDirectory().getAbsolutePath() + "/LearnChineseCP/";
    ...
    {
        //String toneType = mToneTypeSpinner.getSelectedItem().toString();
    ...
    /*public int getToneTypeNum(String toneType)
    {
        if (toneType.contains("阴平"))
            return 1;
        else if (toneType.contains("阳平"))
            return 2;
        else if (toneType.contains("上声"))
            return 3;
        else if (toneType.contains("去声"))
            return 4;
        else return 0;
    }*/
