 ...
 */
public class GenerateDefaultLearningListTask extends AsyncTask<String, Void, Void> {
    private final String LOG_TAG = this.getClass().getSimpleName();

    private final Context mContext;
    private final FragmentActivity mActivity;

    public GenerateDefaultLearningListTask(FragmentActivity context) {
        mContext = context;
        mActivity = context;
    ...
    protected Void doInBackground(String... params) {
        ...
        for (int i = 0;i < list.length;i++) {
            pureContent = Utility.generateCharacterName(list[i].content);
            ...
            contentFlag = Utility.getContentTag(pureContent);
