...
public class TaskGenerateDisplaySequence extends AsyncTask<String, Void, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        for (int i = 0; i < sequence.length; i++) {
            ...
            displaySequenceValue = (opType == FragmentCustomLearning.CLEAR_CHARACTER_SEQUENCE_LOADER)?0:(i + 1);
    ...
    protected void onPostExecute(Integer result) {
        int resourceId = (result == FragmentCustomLearning.CLEAR_CHARACTER_SEQUENCE_LOADER)?R.drawable.play:R.drawable.stop;
