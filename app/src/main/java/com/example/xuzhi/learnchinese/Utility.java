...
import com.example.xuzhi.learnchinese.data.ReadOnlyDbHelper;
...
public class Utility {
    ...
    static public void copyDataBase(Context c) throws IOException {
        ...
        final File dir = new File(c.getFilesDir() + "/data/data/com.example.xuzhi.learnchinese/databases");
        ...
        OutputStream myOutput = new FileOutputStream("/data/data/com.example.xuzhi.learnchinese/databases/ChineseCharacterReadOnly.db");
